...
class QDeclarativeWebView : public QDeclarativeItem {
    ...
    Q_PROPERTY(QString toolTipText READ toolTipText NOTIFY toolTipTextChanged)
    Q_PROPERTY(QPoint toolTipPos READ toolTipPos NOTIFY toolTipPosChanged)
