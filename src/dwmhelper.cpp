...
/*!
  ...
  *
  */
bool DwmHelper::isCompositionEnabled()
{
#ifdef Q_WS_WIN
    if (resolveLibs()) {
        HRESULT hr = S_OK;
...
/*!
  ...
  */
bool DwmHelper::enableBlurBehindWindow(QWidget *widget, bool enable)
{
    Q_ASSERT(widget);
    Q_UNUSED(widget);
    Q_UNUSED(enable);
...
/*!
  ...
  * \a enable tells if the blur should be enabled or not
  */
bool DwmHelper::extendFrameIntoClientArea(QWidget *widget, int left, int right, int top, int bottom)
{
...
/*!
  ...
  * \a enable tells if the blur should be enabled or not
  */
QColor DwmHelper::colorizatinColor()
{
...
#ifdef Q_WS_WIN
WindowNotifier *DwmHelper::windowNotifier()
{
...
bool WindowNotifier::winEvent(MSG *message, long *result)
{
    if (message && message->message == WM_DWMCOMPOSITIONCHANGED) {
        bool compositionEnabled = DwmHelper::isCompositionEnabled();
